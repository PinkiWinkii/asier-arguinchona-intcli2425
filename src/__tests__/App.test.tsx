...
describe('Potion Filtering Functions', () => {
  ...
  test('listIngredients should return the names of the ingredients of a potion', () => {
    ...
    const expectedStringArrayResult = ['Phoenix Feather', 'Molten Ember', 'Flameflower Extract']
    expect(result).toEqual(expectedStringArrayResult);
  });
